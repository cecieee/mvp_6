...
//             <div 
//               key={item.id} 
//               className="group bg-gradient-to-r from-purple-700 to-purple-600 hover:from-purple-400 hover:to-purple-400 backdrop-blur-sm border border-white/10 hover:border-white/30 p-3 mb-3 last:mb-0 rounded-xl transition-all duration-300 hover:scale-[1.02] relative overflow-hidden cursor-pointer"
//             >
//               {/* Shining animation overlay */}
//               <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full bg-gradient-to-r from-transparent via-white/20 to-transparent skew-x-12 transition-transform duration-700 ease-out"></div>
